...
public class LooperLayoutManager extends RecyclerView.LayoutManager {
    ...
    private float speedPerPixel = 100f;//滚动速率 越小越快 越大越慢
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
        RecyclerView.SmoothScroller smoothScroller = new LooperLayoutManager.CenterSmoothScroller(recyclerView.getContext());
